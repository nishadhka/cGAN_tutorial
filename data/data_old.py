...
def gen_fcst_norm(year=2018):
    ...
    stats_dic = {}
    fcstnorm_path = os.path.join('/network/group/aopp/predict/TIP021_MCRAECOOPER_IFS/ICPAC_data/6h_IMERG_v7/tfrecords/', f"FCSTNorm{year}.pkl")
...
def load_fcst_norm(year=2018):
    fcstnorm_path = os.path.join('/network/group/aopp/predict/TIP017_COOPER_SURFACE/cGAN/ICPAC/6h_IMERG_v6_Andrew/constants/', f"FCSTNorm{year}.pkl")
